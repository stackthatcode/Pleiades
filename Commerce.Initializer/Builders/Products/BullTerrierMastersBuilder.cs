...
{
    public class BullTerrierMastersBuilder : ProductBuilder
    {
        ...
        public BullTerrierMastersBuilder(
        ...
        {            
            string name = "Bull Terrier Masters Gi";
            ...
            var bundleList1 = AddImagesFromDirectory(@"Content\BullTerrierMasters");
            _unitOfWork.SaveChanges();
